...
window.DRAW_MATH_URL = 'math4/es5';    // changed to math4 to match my setup
window.DRAWIO_CONFIG = null;

////
window.ALLOW_CUSTOM_PLUGINS=true;    // This line not in the original drawio PreConfig.js file
